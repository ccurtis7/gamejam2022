...
#-----#
# To change the asteroids, you can alter the names of the graphics in this list.
# The new graphic files will need to be put in the img folder. You can add additional
# types of asteroids by making the list longer.
